            ...
            <div className="bg-white border border-gray-300 shadow-md rounded-lg p-4 mb-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center mb-2">
                            <div className="w-1/3 font-medium">Baccalaureate Establishment:</div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center mb-2">
                            <div className="w-1/3 font-medium">Baccalaureate Average:</div>
                            <div className="flex-grow">{bac.bacAverage}</div>
                        </div>
                        {/* National Baccalaureate Average */}
                        <div className="flex items-center mb-2">
                            <div className="w-1/3 font-medium">National Baccalaureate Average:</div>
                            <div className="flex-grow">{bac.nationalBacAverage}</div>
                        </div>
                        {/* Regional Exam Average */}
                        <div className="flex items-center mb-2">
                            <div className="w-1/3 font-medium">Regional Exam Average:</div>
                            <div className="flex-grow">{bac.regionalExamAverage}</div>
                        </div>
                        <div className="flex items-center mb-2">
                            ...
                            <div className="flex-grow">
                                ...
                                <PdfModal shown={openModal} close={() => setOpenModal(false)}>
                                    <iframe src={bac.bacDiploma} className="border-none w-full h-full"></iframe>
                                </PdfModal>
                            </div>
                        </div>
                    </div>
