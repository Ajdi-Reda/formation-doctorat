...
const CandidateData = ({candidateData, auth}) => {
    ...
    const documents = {cv: personalData.cv, recommendationLetter1:
    personalData.recommendationLetter1, recommendationLetter2: personalData.recommendationLetter2}
            ...
            <div className="mt-16 space-y-4">
                <div className="flex justify-between">
                    ...
                    <button type="button"
                            ...
                            className="focus:outline-none text-white bg-indigo-500 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Download Files
                    </button>
                </div>
                ...
                <div className="mt-4">
                    <button type="submit"
                        ...
                        className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Reject
                </button>
                <button type="submit"
                        onClick={() => setData('accepted', 'accepted')}
                        className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Accept
                </button>
            </div>
            </form>
        </AuthenticatedLayout>
